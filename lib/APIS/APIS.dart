class myApi {
  ...
  static const String HomeAPI = BaseUrl + '/api/home_api';
  static const String DonataionListAPI = BaseUrl + '/api/donation_list';
  static const String WishListAPI = BaseUrl + '/api/wishes_list';
  static const String AchievementListAPI = BaseUrl + '/api/achievement_list';
  static const String ProfileAPI = BaseUrl + '/api/profile';
  static const String CountryApI = BaseUrl + '/api/country';
  static const String StateApI = BaseUrl + '/api/state';
  static const String CityApI = BaseUrl + '/api/city';
  static const String AreaApI = BaseUrl + '/api/area';
  ...
  static const String occupationListAPI = BaseUrl + '/api/occupation_list';
  static const String userLists = BaseUrl + '/api/users_name';
  static const String AddUserAPI = BaseUrl + '/api/add_users';
